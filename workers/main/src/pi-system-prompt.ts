...
export function createPiSystemPrompt(
  ...
  const deployedConnectionsEnabled = options.deployedConnectionsBindingEnabled !== false;
  ...
  return [
    ...
    deployedConnectionsEnabled ? null : DEPLOYED_CONNECTIONS_BINDING_DISABLED_PROMPT,
    webResearchGuidance,
